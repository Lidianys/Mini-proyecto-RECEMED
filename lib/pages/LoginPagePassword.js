...
function LoginPagePassword() {
  ...
  var handleLogin = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var response, _errorData$errors, errorData, data, firstProfile, fullName;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 3:
            _context.prev = 3;
            _context.next = 6;
            return fetch("http://rec-staging.recemed.cl/api/users/log_in", {
              method: "POST",
              headers: {
          ...
          case 10:
            ...
            throw new Error(((_errorData$errors = errorData.errors) === null || _errorData$errors === void 0 ? void 0 : _errorData$errors.detail) || "Error en la autenticación");
          case 12:
            _context.next = 14;
            return response.json();
          case 14:
            ...
            if (data.data && data.data.profiles && data.data.profiles.length > 0) {
              firstProfile = data.data.profiles[0];
              fullName = "".concat(firstProfile.first_name || "", " ").concat(firstProfile.last_name || "").trim();
  ...
  }, "Ingrese su Contrase\xF1a"), /*#__PURE__*/React.createElement("input", {
    type: "password",
...
var _default = exports["default"] = LoginPagePassword;